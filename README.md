...
![公式工作区](docs/preview-workspace.png)

### 源码模式（语法验证）

![源码模式](docs/preview-source-mode.png)

### 数学计算工作台

![数学计算](docs/preview-compute.png)

### 手写公式识别

![手写输入](docs/preview-handwriting.png)

### PDF 公式提取

![PDF 提取](docs/preview-pdf.png)
...
- **手写公式识别** — Canvas 画布手写数学公式，画笔/橡皮擦/撤销/清空，触摸支持，一键识别
...
| 手写输入 | Canvas 画布手写公式，画笔/橡皮擦/撤销/清空，触摸支持，一键识别 |
