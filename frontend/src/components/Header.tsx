    ...
    <header className="sticky top-0 z-20 border-b border-slate-200 bg-white/85 backdrop-blur dark:border-slate-800 dark:bg-slate-950/85">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-3 py-2 sm:px-4 sm:py-3">
        ...
        <div className="flex items-center gap-1 sm:gap-2">
          <button onClick={onToggleDark} className="rounded-xl border border-slate-200 px-2 py-1.5 text-sm dark:border-slate-700 dark:text-slate-100 sm:px-3 sm:py-2">
            {dark ? '☀️' : '🌙'}
          </button>
          ...
          <button
            ...
            className="rounded-xl border border-slate-200 px-2 py-1.5 text-sm dark:border-slate-700 dark:text-slate-300 sm:px-2.5 sm:py-2"
            title="配置设置"
          >
            ⚙️
          </button>
          ...
          <a
            href="https://github.com/xiaoyeTC/LocalMathOCR"
            target="_blank"
            rel="noopener noreferrer"
            className="hidden rounded-xl border border-slate-200 px-2.5 py-1.5 text-sm text-slate-600 hover:border-primary hover:text-primary dark:border-slate-700 dark:text-slate-300 sm:block"
            title="GitHub"
          >
